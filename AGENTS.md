...
- [`docs/milestones/x21_OB_DEPLOYMENT.md`](docs/milestones/x21_OB_DEPLOYMENT.md) is the closed record of the open-beta transition; [`docs/milestones/22_OPEN_BETA_PRODUCT_GROWTH.md`](docs/milestones/22_OPEN_BETA_PRODUCT_GROWTH.md) is active with its revised product-and-growth scope drafted for review.
