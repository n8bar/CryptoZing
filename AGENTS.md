...
- [`docs/milestones/21_OB_DEPLOYMENT.md`](docs/milestones/21_OB_DEPLOYMENT.md) owns M21's accepted M20 baseline, in-place transition scope, and phase status; the `docs/strategies/21.*` phase strategies are approved execution direction.
