...
- Email aliasing (`MAIL_ALIAS_ENABLED/MAIL_ALIAS_DOMAIN`) can rewrite recipients to the CryptoZing catch-all (`mailer.cryptozing.app` → Proton) for test scenarios. Currently disabled — MS19 runs under prod-like routing. Keep it disabled for open beta and any real-customer deployment.
