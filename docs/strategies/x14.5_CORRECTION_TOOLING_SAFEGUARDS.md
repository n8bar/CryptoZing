...
2. [x] Confirm the controlled MS14 baseline from [`docs/strategies/14.1_BASELINE_RESEED.md`](x14.1_BASELINE_RESEED.md) is present. If invoices `50` through `58` are missing, stop and rebuild that baseline first.
