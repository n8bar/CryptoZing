...
This document outlines the exact feature tests we plan to implement next, reflecting the active open-beta plan in `docs/PLAN.md` and the cross-feature behavior in `docs/PRODUCT_SPEC.md`. Each test case lists preconditions, steps, and key assertions.
