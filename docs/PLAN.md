...
| [ ] | 19 | RC Hardening & Ops | RC hardening before mainnet cutover: notification coverage audit, auth/password policy hardening (419-to-login redirect, site-wide session expiry logout), legal layer (ToS, Privacy Policy, disclaimer copy, UI placement, monetization-neutral language pass), content promises reconciliation, and contributor docs refresh. | 2026-06-11 | [`docs/milestones/19_RC_HARDENING_OPS.md`](milestones/19_RC_HARDENING_OPS.md) |
