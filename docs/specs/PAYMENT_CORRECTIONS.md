...
This doc complements [`docs/specs/PARTIAL_PAYMENTS+CONFIRMATIONS.md`](PARTIAL_PAYMENTS+CONFIRMATIONS.md). Manual adjustments remain a separate ledger feature; this spec covers correction of detected on-chain rows that should no longer count toward an invoice.
