...
New registrations land pending and cannot log in until approved from the support dashboard. Registration stays open and unchanged. Independent of mainnet, so it can lead. Strategy: [`20.1_ALPHA_ACCESS_GATE.md`](../strategies/20.1_ALPHA_ACCESS_GATE.md).
