...
### [x] Phase 1 — Notification Coverage Audit & Verification %<9559>
...
### [x] Phase 2 — Auth/Password Policy Hardening %<9560>
...
### [x] Phase 4 — Visual Identity Polish %<9562>
...
### [x] Phase 6 — Content Promises Reconciliation %<9564>
...
### [x] Phase 7 — Contributor Docs Review %<9565>
...
### [x] Phase 9 — Two-Factor Authentication %<9567>
...
- [x] Notification coverage documented AND verified end-to-end: every outbound mail type accounted for with intended trigger, recipient, delivery-log behavior, and realistic end-to-end verification (including time-advanced past-due flows). Catch-all alias disabled; later MS19 phases run under prod-like mail routing. %<10048>
- [x] 419-to-login redirect implemented and tested. %<10049>
- [x] Site-wide session expiry logout implemented and tested. %<10050>
- [x] LLCs formed in Arizona; EINs obtained; operating agreements signed; publication affidavits filed; CryptoZing references updated to reflect the entity. %<10051>
- [x] Single CryptoZing favicon set generated and wired site-wide (Laravel app + marketing/Pages site) — one mark, no per-surface variants. %<10052>
- [x] og:image card + social-preview meta wired on the marketing site and validated against the platform preview tools. %<10053>
- [x] No "RC" / "Release Candidate" in user-facing copy (deployed RC is publicly "open beta"); "pre-release" kept where accurate; internal docs/comments unchanged. %<10054>
- [x] Branded, guest-safe error pages — 404/500/503/429 plus 403 migrated off the auth-assuming layout; 500 leaks no debug detail (#96). %<10055>
- [x] ToS and Privacy Policy drafted (Phase 5). Publication (effective dates + live links) is deliberately deferred to the MS21 deploy — same as the donation page and error-page framing (MS19 builds; MS21 goes live). %<10056>
- [x] Disclaimer copy present at signup, wallet onboarding, and invoice/payment surfaces; footer links to ToS and Privacy Policy on every page. %<10057>
- [x] Existing UI and mail copy reviewed for overstatements, financial advice language, and pricing commitments — issues resolved. %<10058>
- [x] Monetization-safe language guide produced for future copy decisions. %<10059>
- [x] Content promises catalog reconciled — every open entry confirmed honored or resolved (content revised or product adjusted). %<10060>
- [x] Contributor docs reviewed and current. %<10061>
- [x] Phase 8 (Micro-Monetize): scope decided (BTC-only, stays in MS19; fiat donations backlogged); donation surface built and verified on testnet — ships dark, public at the MS21 deploy. See [`x19.8`](../strategies/x19.8_MICRO_MONETIZE.md). %<10062>
- [x] Email 2FA available as opt-in; emailed-code recovery per the Phase 9 decision in place. %<10063>
- [x] Recommendation surface (non-blocking dashboard banner) for users without 2FA enabled is shipped. %<10064>
- [x] TOTP shipped (cutoff met) — authenticator app with QR + manual enrollment and the emailed-code fallback. %<10065>
