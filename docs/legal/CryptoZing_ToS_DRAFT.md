...
> **Open on §9:** (c) add one general Privacy-Policy pointer elsewhere in the doc. *(Resolved: (a) deletion scope — full deletion, wording applied above; (b) survival clause — omitted, matching the Basecamp base.)*
