...
> **Open on §9:** (b) survival clause final wording; (c) add one general Privacy-Policy pointer elsewhere in the doc. *((a) deletion scope: resolved — full deletion, wording applied above.)*
