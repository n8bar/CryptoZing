...
- *Website analytics*: some of our sites count page views and record the page address, referrer, browser details, and a country derived from your IP but not the IP. Signed-in app pages and invoice pages are excluded.
