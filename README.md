...
- M21 phase strategies: [Prepare the in-place release](docs/strategies/x21.1_PRE_DEPLOY_VERIFICATION.md), [Switch to the apex and open beta](docs/strategies/21.2_DEPLOY_AND_CUTOVER.md), [Verify the public result and sign off](docs/strategies/21.3_ROLLOUT_VERIFICATION_SIGNOFF.md)
