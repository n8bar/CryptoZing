...
- Active milestone: [`docs/milestones/21_OB_DEPLOYMENT.md`](docs/milestones/21_OB_DEPLOYMENT.md) (M21; strategy drafts awaiting review)
- M21 phase strategies: [Pre-deploy verification](docs/strategies/21.1_PRE_DEPLOY_VERIFICATION.md), [Deploy and cutover](docs/strategies/21.2_DEPLOY_AND_CUTOVER.md), [Rollout verification and sign-off](docs/strategies/21.3_ROLLOUT_VERIFICATION_SIGNOFF.md)
