...
- Self-host guide: [`docs/ops/get-live/README.md`](docs/ops/get-live/README.md)
- Running a server & halt procedure: [`docs/ops/RUNNING_THE_SERVER.md`](docs/ops/RUNNING_THE_SERVER.md)
- Active milestone: [`docs/milestones/22_OPEN_BETA_PRODUCT_GROWTH.md`](docs/milestones/22_OPEN_BETA_PRODUCT_GROWTH.md) (M22; revised product-and-growth scope drafted for review). Closed: [`docs/milestones/x21_OB_DEPLOYMENT.md`](docs/milestones/x21_OB_DEPLOYMENT.md) (M21)
- M21 phase strategies: [Prepare the in-place release](docs/strategies/x21.1_PRE_DEPLOY_VERIFICATION.md), [Switch to the apex and open beta](docs/strategies/x21.2_DEPLOY_AND_CUTOVER.md), [Verify the public result and sign off](docs/strategies/x21.3_ROLLOUT_VERIFICATION_SIGNOFF.md)
